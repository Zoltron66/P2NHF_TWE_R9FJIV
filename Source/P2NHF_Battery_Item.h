...
*   egyedi tulajdonsaggal, ami a toltottseg (akkumulator toltottsege).
...
*	another unique property, which is the charge (battery charge).
...
// ======================================================================================================
class TWE_API P2NHF_Battery_Item : public P2NHF_Item
{
private:
	float Charge;

public:
	P2NHF_Battery_Item() : Charge(0.0f) {}
	P2NHF_Battery_Item(const P2NHF_Item* Param);
	virtual ~P2NHF_Battery_Item() {}

	// Accessor methods for charge
	void SetCharge(const float Param);
	float GetData() const override final { return Charge; }
