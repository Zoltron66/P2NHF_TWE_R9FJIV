...
/*
* TWE - P2NHF_Fuel_Item_PhysicalRep.h
*
* [HU]
* Az osztaly leirasa:
...
*   a modellt allitja be ez az osztaly es parositja az üzemanyag adataival.
...
*   and matched with the fuel data.
...
#include "P2NHF_Fuel_Item_PhysicalRep.generated.h"

// ======================================================================================================
UCLASS()
class TWE_API AP2NHF_Fuel_Item_PhysicalRep : public AP2NHF_Item_PhysicalRep
{
	GENERATED_BODY()

private:
	P2NHF_Fuel_Item FuelData;

public:
	AP2NHF_Fuel_Item_PhysicalRep();
