...
/*
* TWE - P2NHF_Fuse_Item_PhysicalRep.h
*
* [HU]
* Az osztaly leirasa:
...
*   a modellt allitja be ez az osztaly es parositja a biztositek adataival.
...
*   and matched with the fuse data.
...
#include "P2NHF_Fuse_Item_PhysicalRep.generated.h"

// ======================================================================================================
UCLASS()
class TWE_API AP2NHF_Fuse_Item_PhysicalRep : public AP2NHF_Item_PhysicalRep
{
	GENERATED_BODY()

protected:
	P2NHF_Fuse_Item FuseData;

public:
	AP2NHF_Fuse_Item_PhysicalRep();
